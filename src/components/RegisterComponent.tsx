			...
			<div className={"w-full flex justify-center "}>
				<form onSubmit={handleSubmit}>
					...
					<div className="flex items-start mb-6">
						...
						<label  className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I
							agree with the <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley" className="text-blue-600 hover:underline dark:text-blue-500">terms
